<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="comp229_project1.Register" %>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="text-right">
                            ...
                            <asp:Button Text="Register" ID="RegisterButton" runat="server" CssClass="btn btn-success" OnClick="RegisterButton_Click" TabIndex="0" />
                        </div>
                    </div>
                </div>
            </div>
